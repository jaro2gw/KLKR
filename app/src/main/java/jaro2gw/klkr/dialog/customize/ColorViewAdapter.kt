...
class ColorViewAdapter(private val context: CustomizeActivity) : ArrayAdapter<Int>(context, R.layout.color_choice, colors) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View = convertView
            ?: with(context.getSystemService(Context.LAYOUT_INFLATER_SERVICE).let { it as LayoutInflater }.inflate(R.layout.color_choice, parent, false)) {
